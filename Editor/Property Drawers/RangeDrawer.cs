...
namespace Foundation.Editors {
	...
	internal sealed class RangeDrawer : Root_RangeDrawer {
		...
		public const string LOWER_BOUND_PROPERTY_NAME = nameof(Range<byte>.lowerBound);
		public const string UPPER_BOUND_PROPERTY_NAME = nameof(Range<byte>.upperBound);
	}
}