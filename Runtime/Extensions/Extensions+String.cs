...
namespace Foundation {
	public static partial class Extensions {
		public static string Joined(this IEnumerable<string> collection, string separator) => String.Join(separator, collection);

		public static string Joined(this IEnumerable<string> collection, char separator) => String.Join(separator, collection);

		public static string Joined(this IEnumerable<char> collection, string separator) => String.Join(separator, collection);

		public static string Joined(this IEnumerable<char> collection, char separator) => String.Join(separator, collection);
